...
echo "Empaquetar todos los Scripts de la carpeta shellCorse y trasferirlos por la red a otro equipo utilizando el comando rsync"
...
rsync -avz $(pwd) $usuario@$host:/Users/zaier
